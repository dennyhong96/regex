...
// #5 String.prototype.match() method - Extract matches
...
// #7 Match anything with wildcard .
...
// #16 Match beginning string pattern
console.log(/^Cal/.test("Cal and Ricky both like racing.")); // true

// #17 Match ending string pattern
...
// #19 Match everything but letters and number
...
// #30 Remove whitespace from start and end
